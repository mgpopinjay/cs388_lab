...
def train_bad_ner_model(training_set: List[LabeledSentence]) -> BadNerModel:
    ...
    # print("\nwords_to_tag_counters:", words_to_tag_counters)
...
if __name__ == '__main__':
    ...
    # ['Token(CRICKET, NNP, I-NP)', 'Token(-, :, O)', 'Token(LEICESTERSHIRE, NNP, I-NP)', 'Token(TAKE, NNP, I-NP)',
    # 'Token(OVER, IN, I-PP)', 'Token(AT, NNP, I-NP)', 'Token(TOP, NNP, I-NP)', 'Token(AFTER, NNP, I-NP)',
    # 'Token(INNINGS, NNP, I-NP)', 'Token(VICTORY, NN, I-NP)', 'Token(., ., O)']
    # ['(2, 3, ORG)']
    ...
    if system_to_run == "BAD":
        ...
        print("Bad NER took %f seconds" % (time.time() - dev_start_time))
